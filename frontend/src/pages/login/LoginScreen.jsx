    ...
    >
      <div style={{ textAlign: "center" }}>
        <img
          ...
          style={{ width: "25%", maxWidth: "400px", height: "60px", marginBottom: "10px" }}
        />
        <h1 style={{ fontSize: "2rem", color: "#333" }}>{kname}</h1>
        <p style={{ color: "#333" }}>
          Where you can find all the amazing musical instruments
        </p>
      </div>
      ...
      <div className=''>
        ...
        <form>
          ...
          <div style={{ marginBottom: "15px", textAlign: "center" }}>
            <ReCAPTCHA
              sitekey="6LdQvMgqAAAAAM_OmPjeLn_FoU-r8VmBq6TGWcxf"
